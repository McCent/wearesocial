...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_test_rT0EMxhzNddBJbiu0ZFH3mEn')

STRIPE_SECRET = os.getenv('STRIPE_SECRET','sk_test_va4P0hDQHMLQsqSEQYhlEaTY')
